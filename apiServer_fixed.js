...
// Stub: proxy/proxyServer no existe en main — desactivamos para que la app arranque
const createProxyRoutes = (app) => { console.log('[stub] proxy routes disabled (module missing)'); };
const processStreamsForProxy = (streams) => streams;
